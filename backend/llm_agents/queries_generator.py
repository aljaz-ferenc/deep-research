...
instructions = (
    ...
    "Provide the explanation in markdown format using only bullet points. Use * (asterisk and space) for each bullet. Do not include headings. Each bullet should briefly describe the topic or subtopic that the queries aim to address "
